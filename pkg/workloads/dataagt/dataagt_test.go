...
func TestSpawn(t *testing.T) {
	...
	{
		theory := func(mode kdb.DataAgentMode) func(t *testing.T) {
		...
		t.Run("[Read]", theory(kdb.DataAgentRead))
		t.Run("[Write]", theory(kdb.DataAgentWrite))
	}
		...
		theory := func(mode kdb.DataAgentMode) func(t *testing.T) {
			return func(t *testing.T) {
				t.Run("When Dataagt exceeds deadline, it returns workloads.ErrDeadlineExceeded", func(t *testing.T) {
					...
					if !errors.Is(err, wl.ErrDeadlineExceeded) {
