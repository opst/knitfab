...
func TestRun_ChangingStatus_DatabaseIsEmpty(t *testing.T) {
...

	{
		...
		t.Run("[PickAndSetStatus] any runs should not be picked (image plan & pseudo plan)", theory(kdb.RunCursor{
		...
		t.Run("[PickAndSetStatus] any runs should not be picked (pseudo plan only)", theory(kdb.RunCursor{
			Status: []kdb.KnitRunStatus{
				kdb.Deactivated, kdb.Waiting,
				kdb.Ready, kdb.Starting, kdb.Running,
				kdb.Aborting, kdb.Completing,
		...
		t.Run("[PickAndSetStatus] any runs should not be picked (image plan only)", theory(kdb.RunCursor{
			Status: []kdb.KnitRunStatus{
				kdb.Deactivated, kdb.Waiting,
				kdb.Ready, kdb.Starting, kdb.Running,
				kdb.Aborting, kdb.Completing,
		...
		t.Run("[PickAndSetStatus] any runs should not be picked (no states)", theory(kdb.RunCursor{
			Status: []kdb.KnitRunStatus{},
			Pseudo: []kdb.PseudoPlanName{PseudoActive, PseudoInactive},
		}))
		t.Run("[PickAndSetStatus] any runs should not be picked (pseudo plan only, but plan names are empty)", theory(kdb.RunCursor{
			Status: []kdb.KnitRunStatus{
				kdb.Deactivated, kdb.Waiting,
				kdb.Ready, kdb.Starting, kdb.Running,
				kdb.Aborting, kdb.Completing,
