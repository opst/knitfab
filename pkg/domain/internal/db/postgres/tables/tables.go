...
func (f *Tables) RegisterUserTagsForData(knitId string, usertags []domain.Tag) error {
...
func (f *Tables) RegisterUserTagsForInput(inputId int, usertag []domain.Tag) error {
...
func (f *Tables) RegisterUserTagsForOutput(outputId int, usertag []domain.Tag) error {
