	...
	for _, testcase := range []struct {
	...
	}{
		{
			...
			change: []Expectation{
				{
					Statuses: []domain.KnitRunStatus{
						domain.Running, domain.Aborting, domain.Completing,
					},
					Assertion: CanBeChanged,
				},
				{
					Statuses: []domain.KnitRunStatus{
						domain.Waiting, domain.Deactivated, domain.Ready, domain.Starting,
						domain.Failed, domain.Done, domain.Invalidated,
					},
