			...
			given: tables.Operation{
				...
				Inputs: map[tables.Input]tables.InputAttr{
					{PlanId: th.Padding36("plan:2/preprocessing"), Path: "/in/raw-data", InputId: 2100}: {
						UserTag: []domain.Tag{{Key: "type", Value: "raw-data"}},
					},
					{PlanId: th.Padding36("plan:2/preprocessing"), Path: "/in/configs", InputId: 2200}: {
						UserTag: []domain.Tag{{Key: "type", Value: "configs"}},
					},
				},
				...
				Steps: []tables.Step{
					{
						Run: tables.Run{
							RunId: th.Padding36("run:1-1/uploaded"), Status: domain.Done,
					...
					{
						Run: tables.Run{
							RunId: th.Padding36("run:1-2/uploaded"), Status: domain.Done,
							UpdatedAt: try.To(rfctime.ParseRFC3339DateTime(
			...
			given: tables.Operation{
				...
				Inputs: map[tables.Input]tables.InputAttr{
					...
					{PlanId: th.Padding36("plan:2/preprocessing"), Path: "/in/params", InputId: 2300}: {
						UserTag: []domain.Tag{{Key: "type", Value: "params"}},
					},
					{PlanId: th.Padding36("plan:3/split"), Path: "/in/configs", InputId: 3100}: {
						UserTag: []domain.Tag{{Key: "type", Value: "raw-data"}},
					},
				...
				Steps: []tables.Step{
					...
					{
						Run: tables.Run{
							RunId: th.Padding36("run:1-3/uploaded"), Status: domain.Done,
							UpdatedAt: try.To(rfctime.ParseRFC3339DateTime(
								"2021-04-05T10:11:12.345+00:00",
							)).OrFatal(t).Time(),
							PlanId: th.Padding36("plan:1/uploaded"),
					...
					{
						Run: tables.Run{
							RunId: th.Padding36("run:1-4/uploaded"), Status: domain.Done,
							UpdatedAt: try.To(rfctime.ParseRFC3339DateTime(
								"2021-04-05T10:11:12.345+00:00",
							)).OrFatal(t).Time(),
							PlanId: th.Padding36("plan:1/uploaded"),
