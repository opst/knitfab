...
To renew and update certifications, follow [admin-guide](https://github.com/opst/knitfab-docs/blob/develop/v1.6.0/03.admin-guide/admin-guide-installation.en.md#42-update-and-replace-tls-certifications-in-knitfab).
...
- Kubernetes Client library "[k8s.io/client-go](https://github.com/kubernetes/client-go)" is upgraded to v0.32.0.
...
Download the installer from branch [develop/v1.6.0](https://github.com/opst/knitfab/tree/develop/v1.6.0), and run
